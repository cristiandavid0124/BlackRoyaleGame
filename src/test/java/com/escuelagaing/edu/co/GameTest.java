...
public class GameTest {
    ...
    private List<Player> createPlayers() {
        ...
        User user1 = new User("1", "user1@example.com", "Player1", "Player1Display", "Player1Given", "Player1Family");
        User user2 = new User("2", "user2@example.com", "Player2", "Player2Display", "Player2Given", "Player2Family");
